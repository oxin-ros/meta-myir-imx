...
echo "IMAGE_INSTALL += \"iproute2 iproute2-bash-completion kernel-module-wireguard wireguard-tools wireguard-tools-bash-completion wireguard-module\"" >> conf/local.conf
